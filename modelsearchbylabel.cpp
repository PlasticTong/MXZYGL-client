...
modelsearchbylabel::modelsearchbylabel(QWidget *parent) : QWidget(parent)
{
...
//    _modeltable_model   = new ModelTable(1, 1);
    _modeltable_models  = new modeltablelabel(3, 3);
...
//void modelsearchbylabel::on_pushbtn_filepath_clicked()
//{
...
//void modelsearchbylabel::on_lineedit_filepath_editingFinished()
//{
//    QString text = QInputDialog::getText(this, tr("输入文本"), tr("请输入文本："));
...
void modelsearchbylabel::on_pushbtn_search_clicked()
{
...
//    }
    ...
    models["type"] = REQUEST_SEARCHLABEL;     // 请求类型
...
void modelsearchbylabel::doDataRecved(QByteArray head, QByteArray body)
{
    // 反序列化数据
...
void modelsearchbylabel::on_pushbtn_prev_clicked()
{
    qDebug() << "to prev page.";
}

void modelsearchbylabel::on_pushbtn_next_clicked()
{
}
