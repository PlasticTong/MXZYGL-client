#ifndef modelsearchbytype_H
#define modelsearchbytype_H
#include <QWidget>
#include <QtWidgets>
...
#endif
class modelsearchbytype: public QWidget
{
    Q_OBJECT
public:
     explicit modelsearchbytype(QWidget *parent = nullptr);
