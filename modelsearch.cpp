...
ModelSearch::ModelSearch(QWidget *parent) : QWidget(parent)
{
    ...
    QVBoxLayout *vboxlayout_modeltosearch = new QVBoxLayout();
...
//    _groupbox_modeltosearch->setGeometry(100, 100, 200, 50);
    ...
    QSplitter *hsplitter_all = new QSplitter(Qt::Horizontal);
...
void ModelSearch::on_pushbtn_search_clicked()
{
    // 获取模型
    ...
    models["type"] = REQUEST_SEARCHMODEL;     // 请求类型
...
void ModelSearch::doDataRecved(QByteArray head, QByteArray body)
{
    // 反序列化数据
...
void ModelSearch::on_pushbtn_prev_clicked()
{
    qDebug() << "to prev page.";
}

void ModelSearch::on_pushbtn_next_clicked()
{
}
