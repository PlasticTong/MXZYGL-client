#ifndef MODELSEARCHBYLABEL_H
#define MODELSEARCHBYLABEL_H
#include <QWidget>
#include <QtWidgets>
...
#endif
class modelsearchbylabel: public QWidget
{
    Q_OBJECT
public:
     explicit modelsearchbylabel(QWidget *parent = nullptr);
...
private:
    ...
    modeltablelabel  *_modeltable_models = nullptr;
