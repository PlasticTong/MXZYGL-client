#ifndef MODELTABLELABEL_H
#define MODELTABLELABEL_H
...
class modeltablelabel : public QWidget
{
    Q_OBJECT
public:
    explicit modeltablelabel(uint panel_rows = 3, uint panel_cols = 3, QWidget *parent = nullptr);
